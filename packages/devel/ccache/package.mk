...
pre_configure_host() {
  ...
  PKG_CMAKE_OPTS_HOST="-DREDIS_STORAGE_BACKEND=OFF -DENABLE_DOCUMENTATION=OFF -DENABLE_TESTING=OFF -DZSTD_FROM_INTERNET=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5"
}

pre_configure_init() {
  PKG_CMAKE_OPTS_INIT="-DREDIS_STORAGE_BACKEND=OFF -DENABLE_DOCUMENTATION=OFF -DENABLE_TESTING=OFF -DZSTD_FROM_INTERNET=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5"
}
