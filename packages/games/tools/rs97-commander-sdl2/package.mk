...
PKG_SHA256="4185d8955f045666d43b79d8dcb4784762b4630b98d0de10f3322ca65779240c"
...
pre_configure_target() {
  ...
  sed -i -E "s#(${SYSROOT_PREFIX}/usr/bin/)+sdl2-config#sdl2-config#g; s#sdl2-config#${SYSROOT_PREFIX}/usr/bin/sdl2-config#g" Makefile
